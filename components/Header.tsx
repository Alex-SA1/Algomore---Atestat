    ...
    <header className="fixed top-0 w-full clearNav z-50">
      <div className="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        <div className="flex flex-row items-center justify-between p-3 md:p-1">
          ...
          /><img src="logo.png" className="w-20 rounded-full"></img>
          <button
        ...
        >
          <div className="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            ...
            <div className="relative">
              ...
              >
                <span className="tr04">Opțiuni</span>
                <svg
                  className={
                    flyer === true
                ...
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-black px-2 py-6 sm:gap-8 ">
                    ...
                    >
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Creează-ți unul acum și fă parte din comunitatea AlgoMore!
                        </p>
                      </div>
                    </Link>
                    <Link
                    ...
                    >
                      <div className="ml-4">
                        <p className="text-base font-medium text-white">
                          Ești deja membru AlgoMore?
                        </p>
                        <p className="mt-1 text-sm text-gray-500">
                          Atunci intră în cont
                        </p>
                      </div>
                    </Link>
                    <Link
