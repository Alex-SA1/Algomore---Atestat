...
import testCases from '@/public/indicatorEulerTestCases.json';
import Head from 'next/head';

const indicatorEuler = () => {
...
`int indicatorEuler(int n)
{
    ...
    const fetchPrograms = async () => {
      try {
        ...
        const programsData = programsSnapshot.docs.map((doc: any) => ({
          id: doc.id,
          ...doc.data(),
        })).filter((data) => data.idAlgorithm === 'indicatorEuler');
  ...
  return (
    <div className="bg-[#020617] min-h-screen">
      <Head>
            <title>Indicatorul lui Euler - AlgoMore</title>
            <link rel="icon" href="/logo.png" />
      </Head>
      <NavbarAlgorithmPage />
      <div className="container mx-auto p-2 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-gray-300">Indicatorul lui Euler</h1>
          ...
          <p className="text-gray-300 font-serif text-lg md:text-md lg:text-xl xl:text-2xl leading-7">
            &middot; <b>Indicatorul lui Euler </b> reprezintă numărul de numere mai mici sau egale cu un număr și prime cu acesta<br></br>
            Formula de calcul este: <br></br>
            &rarr; &#40;d<sub>1</sub>-1&#41;*d<sub>1</sub><sup>p<sub>1</sub>-1</sup> * &#40;d<sub>2</sub>-1&#41;*d<sub>2</sub><sup>p<sub>2</sub>-1</sup> * ... * &#40;d<sub>k</sub>-1&#41;*d<sub>k</sub><sup>p<sub>k</sub>-1</sup> ,
            unde d<sub>1</sub>, d<sub>2</sub>, ..., d<sub>k</sub> reprezintă factorii primi, iar p<sub>1</sub>, p<sub>2</sub>, ..., p<sub>k</sub> reprezintă
            puterile factorilor primi
            </p>

            <Codemirror
              value={indicatorEuler}
              theme={vscodeDark}
              extensions={[cpp()]}
              style={{fontSize: 17}}
              editable={false}
