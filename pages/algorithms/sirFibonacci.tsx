...
import testCases from '@/public/sirFibonacciTestCases.json';
...
`
    ...
    const fetchPrograms = async () => {
      try {
        ...
        const programsData = programsSnapshot.docs.map((doc: any) => ({
          id: doc.id,
          ...doc.data(),
        })).filter((data) => data.idAlgorithm === 'sirFibonacci');
  ...
  return (
    <div className="bg-[#020617] min-h-screen">
      <Head>
            <title>Șirul lui Fibonacci - AlgoMore</title>
            <link rel="icon" href="/logo.png" />
      </Head>
      <NavbarAlgorithmPage />
      <div className="container mx-auto p-2 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-gray-300">Șirul lui Fibonacci</h1>
          ...
          <div className="prose prose-lg">
            <p className="text-gray-300 font-serif text-lg md:text-md lg:text-xl xl:text-2xl leading-7">
                Acest șir &#40;F<sub>n</sub>&#41; <sub>n≥1</sub> este generat pe baza următoarei recurențe : <br></br>
                &middot; F<sub>1</sub> &#61; F<sub>2</sub> &#61; 1 <br></br>
                &middot; F<sub>n</sub> &#61; F<sub>n-1</sub> + F<sub>n-2</sub>
                <br></br>
                Implementarea următoare afișează <b> primii n termeni ai șirului lui Fibonacci </b> utilizând o structură repetitivă și trei variabile, 
                stocând termenul curent, termenul anterior și termeneul ante anterior.
            </p>
