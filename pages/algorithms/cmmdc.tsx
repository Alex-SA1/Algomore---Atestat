...
import testCases from '@/public/cmmdcTestCases.json';
...
const cmmdc = () => {
  ...
  const scaderi =
`int scaderiRepetate(int a, int b)
{
    if(a==0 && b==0)
      return 0;
...
`int euclid(int a, int b)
{
    ...
    const fetchPrograms = async () => {
      try {
        ...
        const programsData = programsSnapshot.docs.map((doc: any) => ({
          id: doc.id,
          ...doc.data(),
        })).filter((data) => data.idAlgorithm === 'cmmdc');
  ...
  return (
    <div className="bg-[#020617] min-h-screen">
      <Head>
            <title>Cel mai mare divizor comun - AlgoMore</title>
            <link rel="icon" href="/logo.png" />
      </Head>
      <NavbarAlgorithmPage />
      <div className="container mx-auto p-2 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-gray-300">Cel mai mare divizor comun</h1>
          ...
          <div className="prose prose-lg">
            ...
            &middot; <b>Cel mai mare divizor comun </b>în informatică are aceeași conotație ca și în matematică.

              <br></br><br></br>

              Pentru a putea calcula cel mai mare divizor comun dintre două numere avem două metode de bază, anume algoritmul lui Euclid și metoda prin scăderi
              repetate.

              <br></br><br></br>

              Metoda care utilizează scăderi repetate
            </p>
