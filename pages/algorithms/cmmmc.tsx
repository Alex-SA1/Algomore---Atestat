...
import testCases from '@/public/cmmmcTestCases.json';
...
{
    int p=a*b, cmmdc=celMaiMareDivizorComun(a, b);
    ...
    const fetchPrograms = async () => {
      try {
        ...
        const programsData = programsSnapshot.docs.map((doc: any) => ({
          id: doc.id,
          ...doc.data(),
        })).filter((data) => data.idAlgorithm === 'cmmmc');
  ...
  return (
    <div className="bg-[#020617] min-h-screen">
      <Head>
            <title>Cel mai mic multiplu comun - AlgoMore</title>
            <link rel="icon" href="/logo.png" />
      </Head>
      <NavbarAlgorithmPage />
      <div className="container mx-auto p-2 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-gray-300">Cel mai mic multiplu comun</h1>
          ...
          <p className="text-gray-300 font-serif text-lg md:text-md lg:text-xl xl:text-2xl leading-7">
            &middot;  Pentru a calcula <b> cel mai mare multiplu comun </b> avem o proprietate matematică, anume:<br></br>
                      &rarr; p / cmmdc&#40;a, b&#41;,<br></br>
              unde p reprezintă produsul a două numere, iar cmmdc reprezintă cel mai mare divizor comun al celor două numere
            </p>
          <br></br>
            <Codemirror
              value={cmmmc}
